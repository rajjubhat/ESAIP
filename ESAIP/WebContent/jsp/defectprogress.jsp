					...
					<div class="col-xs-12">
						<div class="box" style="height: 380px;">
							<c:if test="${defectstatus<100}">
								<meta http-equiv="Refresh" content="10;url=progress.do">
							...
							<div class="box-body">
								...
								<div
									...
									<font color=red size=4px><strong>${defectmessage}</strong></font>
								</div>
								<c:if test="${defectstatus<100}">
										...
										<div>
											<div
												...
												<span id="stop" style="display: none"><font color=red
													size=4px>Execution will terminate after current
